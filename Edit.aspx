       ...
       //document.getElementById(Picture).style["visibility"] = "visible";
        ...
        function ChangeSavebtn() {
                if (document.getElementById('Question').value.length >= 2 &&
                    ...
                    if (document.getElementById('SaveQ').style["visibility"] == "visible") {
...
<p style="color:red;">*</p>      
        ...
        <th class="3">
            <asp:TextBox ID="Question" onkeyup="ChangeSavebtn()" item="1" CharacterLimit="80" CssClass="CharacterCount" runat="server" Height="32px" Width="244px" TextMode="MultiLine"></asp:TextBox>
            </th>
...
אפשרויות תשובה
  ...
  <tr>
    ...
    <th class="auto-style3">
     &nbsp;<asp:TextBox ID="Ans0" item="2" CharacterLimit="70" onkeyup="changeTextStatus('pic0', this.id);ChangeSavebtn();" CssClass="CharacterCount" runat="server" Width="210px" TextMode="MultiLine" ></asp:TextBox>
...
<p style="color:red;">*</p>    
    ...
    <th >
     <asp:TextBox ID="Ans1" item="3" CharacterLimit="70" onkeyup="changeTextStatus('pic1', this.id);ChangeSavebtn();" CssClass="CharacterCount" runat="server" Width="210px" TextMode="MultiLine"></asp:TextBox>
...
<tr>
      <th class="auto-style1"></th>
              <th></th>
    <th class="auto-style3">
                    <asp:TextBox ID="Ans2" item="4" CharacterLimit="70" CssClass="CharacterCount" runat="server" onkeyup="changeTextStatus('pic2', this.id)" Width="210px" TextMode="MultiLine"></asp:TextBox>      
    </th>
    <th class="auto-style5">
 ...
 <asp:FileUpload ID="fileInput4" runat="server" onchange="changeButtonStatus('Ans2', this.id,'Deletebtn3')"/>
    ...
    <th class="3">
       <asp:TextBox ID="Ans3"  item="5" CharacterLimit="70" CssClass="CharacterCount"  runat="server"  Width="210px" onkeyup="changeTextStatus('pic3', this.id)" TextMode="MultiLine"></asp:TextBox>
    </th>
        <th class="auto-style5">
 ...
 <asp:FileUpload ID="fileInput5" runat="server" onchange="changeButtonStatus('Ans3', this.id,'Deletebtn4')"/>
    ...
    <asp:ImageButton ID="ShowPic4" runat="server" style="visibility:hidden" Height="50" Width="50"/>
     <asp:ImageButton ID="Deletebtn4" runat="server" style="visibility:hidden" ImageUrl="images/recycle-bin.png" Height="20" Width="20" OnClientClick="pachFunc(this.id,'ShowPic4','fileInput5','pic3','Ans3');return false;" />
      ...
      <div class="tooltip">
      <asp:Button ID="SaveQ" runat="server" Text="שמור שאלה" CssClass="floatleft DisButtons" OnClick="SaveQ_Click" style="visibility:visible" Enabled="False" />                                
  <span class="tooltiptext" > 
      אין אפשרות לשמור שאלה, כיון שדרוש מינימום 2 מסיחים לכל שאלה
  </span>
    </div>   
                    <asp:Button ID="UpdateBtn" runat="server" CssClass="floatleft DisButtons" Text="עדכן" OnClick="UpdateBtn_Click" style="visibility:hidden" Enabled="False" />
                    <asp:Button ID="BackToGamesBtn" runat="server" Text="< חזור" OnClick="BackToGamesBtn_Click" CssClass="DisButtons" />
                </div>
                <div class="item2">
...
<p style="color:red; margin-right:300px; margin-top:-19px;">לפחות 5 שאלות לפרסום</p>
               ...
               <asp:Panel ID="grayWindows" runat="server">
                ...
                <asp:Panel ID="DeleteConfPopUp" CssClass="PopUp" runat="server">
                    ...
                    <asp:Label ID="Label2" runat="server" Text="האם אתה בטוח/ה שברצונך למחוק את השאלה?" style="font-size:20px"></asp:Label>
                    <br /><br />
                     <asp:Button ID="ExitDeleteConf" CssClass="Exit DisButtons" runat="server" Text="כן" OnClick="ExitDeleteConf_Click1" Width="60px" Height="60px" />
                    &nbsp;&nbsp;
                    <asp:Button ID="XnoXDeleteConf" CssClass="Exit DisButtons" runat="server" Text="לא" OnClick="ExitDeleteConf_Click1" Width="60px" Height="60px"/>
                </asp:Panel>
            </asp:Panel>
        </div>
            </div>
