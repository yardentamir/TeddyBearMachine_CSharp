...
תשע"ט </p>
       ...
       <%--   כפתור יצירת משחק--%> <asp:Button ID="ImageButton1" CssClass="DisButtons" runat="server" Text="צור משחק" OnClick="Button1_Click" Enabled="false"/>
                ...
                <br />
                <asp:GridView ID="GridView1" CssClass="gridColor" runat="server" DataSourceID="XmlDataSource1" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="פרסום">
                            <ItemTemplate>
                                  <div id="CheckBoxDiv" class="tooltip cenetrq">
  ...
  <span class="tooltiptext">דרוש לפחות 5 שאלות לפרסום</span>
    </div>                  
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
            ...
            <asp:Panel ID="grayWindows" runat="server">
                ...
                <asp:Panel ID="DeleteConfPopUp" CssClass="PopUp" runat="server">
                    ...
                    <asp:Label ID="messageIfDelete" runat="server" Text="האם אתה בטוח/ה שברצונך למחוק את המשחק?" style="font-size:20px"></asp:Label>
                    <br /><br />
